...
const COLS = [
  { ticker: "AAPL", name: "Apple", type: "stock", region: "US", halal: "compliant", verdict: "buy", price: 201.34, day: 1.62,
    m: { "Market cap": "$2.94T", "P/E (TTM)": "31.2", "Fwd P/E": "27.8", "Div yield": "0.51%", "Net margin": "25.3%", "ROE": "147%", "Debt/Equity": "1.87", "1y return": 22.6 },
    spark: mockData.detail.spark },
  { ticker: "MSFT", name: "Microsoft", type: "stock", region: "US", halal: "compliant", verdict: "buy", price: 432.18, day: -0.84,
    m: { "Market cap": "$3.21T", "P/E (TTM)": "36.0", "Fwd P/E": "31.2", "Div yield": "0.72%", "Net margin": "36.1%", "ROE": "39%", "Debt/Equity": "0.78", "1y return": 28.4 },
    spark: mockData.holdings[2].spark },
  { ticker: "ARAMCO", name: "Saudi Aramco", type: "stock", region: "KSA", halal: "compliant", verdict: "buy", price: 7.84, day: 0.26,
    m: { "Market cap": "$1.89T", "P/E (TTM)": "16.1", "Fwd P/E": "15.4", "Div yield": "6.30%", "Net margin": "27.8%", "ROE": "31%", "Debt/Equity": "0.42", "1y return": 6.1 },
    spark: mockData.watchlist[1].spark },
];
  ...
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", flexDirection: "column", gap: 22 }}>
                ...
                <th key={c.ticker} style={{ padding: "20px 18px", borderBottom: "1px solid var(--border)", borderLeft: "1px solid var(--divider)", textAlign: "center", verticalAlign: "top" }}>
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
                    ...
                    <div style={{ display: "flex", gap: 6, marginTop: 2 }}>
                      ...
                      <HalalBadge status={c.halal} size="sm" showLabel={false} />
                    </div>
                  </div>
                </th>
              ))}
              ...
              return (
                <tr key={row} style={{ background: i % 2 ? "var(--gray-50)" : "transparent" }}>
                  ...
                  {COLS.map((c, j) => {
                    ...
                    if (row === "1y return") {
                      return (
                        <td key={c.ticker} style={{ padding: "13px 18px", textAlign: "center", borderLeft: "1px solid var(--divider)" }}>
                          <ChangeValue value={v} size="sm" showCaret={false} />
                        </td>
                      );
                    }
                    return (
      ...
      <div style={{ display: "flex", gap: 10, justifyContent: "center" }}>
        <Button variant="secondary" leadingIcon={<GFIcon name="plus" size={16} />}>Add a company</Button>
      </div>
    </div>
  );
}
