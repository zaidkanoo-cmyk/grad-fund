...
export function OverviewScreen({ onOpen, data }) {
    ...
    <div style={{ maxWidth: 1180, margin: "0 auto", display: "flex", flexDirection: "column", gap: 22 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.7fr 1fr", gap: 22 }}>
        ...
        <Card pad="lg">
          ...
          <AllocationBar height={14} segments={data.allocation.byClass.map((s) => ({ label: s.label, value: s.value, color: assetColor(s.type) }))} />
