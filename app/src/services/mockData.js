...
const detailSpark = spark(150, 90, 0.5);

const detail = {
  ticker: "AAPL", name: "Apple Inc.", type: "stock", sector: "Technology", region: "US",
  exchange: "NASDAQ", currency: "USD", halal: "compliant", verdict: "buy",
  price: 201.34, day: 1.62, dayAbs: 3.21,
  spark: detailSpark,
  metrics: [
    { label: "Market cap",  value: "$2.94T" },
    { label: "P/E (TTM)",   value: "31.2", hint: "Price ÷ trailing 12-mo earnings" },
    { label: "Fwd P/E",     value: "27.8" },
    { label: "Div yield",   value: "0.51%" },
    { label: "EPS (TTM)",   value: "$6.43" },
    { label: "Revenue",     value: "$385.7B" },
    { label: "Net margin",  value: "25.3%" },
    { label: "ROE",         value: "147%" },
    { label: "Debt / Equity",value: "1.87" },
    { label: "Beta",        value: "1.24" },
    { label: "52-wk range", value: "$164–$237" },
...
export const mockData = {
  ...
  detail,
  summary: {
    totalValue, totalCost, totalGain, totalRet,
    dayChange, dayPct,
    invested: totalCost,
